...
*   **Reflexiones sobre agentes y autonomía**
    ...
    Una exploración continua sobre cómo construir agentes autónomos que no solo reaccionan, sino que perciben, priorizan y recuerdan con coherencia.

    *   *Proactividad y control sensorial*
    ...
    *   *Memoria narrativa y trazabilidad*
...
*   **Notas de campo**
    ...
    *   [El vendedor de empleados invisibles](https://jjdelcerro.github.io/es/blog/el-vendedor-de-empleados-invisibles/)
...
*   **Serie "El Asistente IA en gvSIG"**.
    ...
    *   [Cómo empecé a hablar con la IA desde la aplicación de escritorio gvSIG desktop en Java](https://jjdelcerro.github.io/es/blog/como-empece-a-hablar-con-la-ia-desde-gvsig-desktop/)
    *   [De chat a asistente, creando un conjunto de herramientas contextuales para gvSIG desktop](https://jjdelcerro.github.io/es/blog/de-chat-a-asistente/)
    *   [La odisea de la distribución: el muro de los costes y los callejones sin salida](https://jjdelcerro.github.io/es/blog/la-odisea-de-la-distribucion/)
